...
Rewrite the <b>jQuery.animate</b>'s default behavior. Now it will use <b>CSS3 Transition</b> to perform animations if possible.<br>
...
This plugin uses a optimized way to perform <b>jQuery.animate</b> method, which means you do not need to modify your code but include this plugin in to make all of your <b>jQuery</b> animation into <b>CSS3 Transition</b>.<br>


## Usage

将 [jquery.animate.js] 引在 jQuery 之后。<br>
Include [jquery.animate.js] after jQuery.<br>
...
<b>Transform</b> properties can be modify by <b>.css()</b> method directly.
...
Support all <b>jQuery.animate</b> native way.<br>
...
<b>Transform</b> properties also supports special way.<br>
...
支持复合属性的动画。<br>
Support the animations which need composite properties.<br>
...
Perfectly support <b>.stop()</b> and <b>.finish()</b> method.<br>
```js
...
Support color animation now, and you can use the <b>.stop()</b> method to stop at a specific color.<br>
...
Note that because of <b>CSS3 Transition</b> animation only support three times bezier curve, some easing in [jQuery.easing] may not be supported, such as: Bounce.<br>
If the animation uses <b>Easing</b> which is not support, program will still use the original <b>jQuery.animate</b> methods to perform this animation.<br>
...
Meanwhile, all the <b>Transform</b> property cannot be set <b>Easing</b> separately, because their <b>Transition</b> are set through the <b>Transform</b> property.<br>
<del>So, in this case, only the first <b>Easing</b> will be used as <b>transition-timing-function</b>.</del><br>
In order to compatible animation effects, so in this case, program will use the original <b>jQuery.animate</b> ways to perform this animation.<br>
...
以下是插件支持的缓动列表。<br>
The following is a list of supported easing.<br>
